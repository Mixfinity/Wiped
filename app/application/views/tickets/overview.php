...
?>
	...
	<div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-bug"></i> Home</a></li>
            <li class="active">Correcties</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header fixTop">
                  <h3 class="box-title">Correcties</h3>
                              ...
                              if(1===2):
                                foreach($tickets as $ticket){?>
                                 <tr>
                                   ...
                                   <td><?=$ticket->name?></td>
                                   <td class="hidden-xs"><?=$ticket->contact_name?></td>
                                   <td>
                                     
                                   <a class="btn btn-success pull-right" href="javascript: showProjectPopup(<?=$ticket->id?>);"><i class="fa fa-search"></i></a>
    ...
    <div id="lineItemHolder" style="display: none">
      <div id="" class="line_number_item">
        <span style="padding-bottom: 5px; display: block; border-bottom: 1px solid #f4f4f4; width: 100%"> <span id="ln_title" style="font-weight: bold;">Website aanpassingen tbv Google</span>
          <span class="right"> 
          ...
          <div class="minutes_holder" > 
             ...
             <div class="minutes_input">
              <form method="post" id="minutes_input" class="" onkeypress="return isNumberKey(event);" onSubmit="javascript: setWorkedMinutes(jQuery('#minuten_field', this).val() , jQuery('#minutes_project_line_id', this).val());return false;"> 
                <input type="hidden" id="minutes_project_line_id">

                <div class="input-group">
                  <input type="text" class="form-control" name="minutes" value="" id="minuten_field" placeholder="Minuten">
