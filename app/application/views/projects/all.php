...
<div class="content-wrapper">
    <section class="content-header">
     	...
     	<ol class="breadcrumb">
        	...
        	<li class="active">Alle lopende projecten</li>
      	</ol>
    </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header fixTop">
                  ...
                  <button class="btn btn-success pull-right" onclick="location.href = '/projects/projects/newProject' ">Nieuw</button>
                </div>
                                ...
                                foreach($projects as $project){?>
                                 <tr>
                                  ...
                                  <td><?=$project->project_name?></td>
                                   ...
                                   ?>
                                   <td class="hidden-xs"><?=$percentage?> % <span style="float:right">(<?=calculateToHour($project->total_worked )?> / <?=calculateToHour($project->total_estimation)?>)</span></td>
                                   
                                   <td>
                                     
                                   <a class="btn btn-success pull-right" href="/projects/projects/projectDetails/<?=$project->id?>"><i class="fa fa-arrow-right"></i></a>
  ...
  <script type="text/javascript">
      ...
      function showProjectPopupAdv(f_id){
        jQuery(".modal-body").html(" ");
        resetLineNumberItem();
        var items = '';
        jQuery.getJSON('/projects/projects/getProjectLinesFromAll/' + f_id, function(data){
            var items = [];
            resetLineNumberItem();
    ...
    <div id="lineItemHolder" style="display: none">
      <div id="" class="line_number_item">
        <span style="padding-bottom: 5px; display: block; border-bottom: 1px solid #f4f4f4; width: 100%"> <span id="ln_title" style="font-weight: bold;"></span>
          <span class="right"> 
            <span style="color: #00a65a; font-weight: bold;"><span id="ln_worked"></span></span> / <span id="ln_estimated"></span> min 
