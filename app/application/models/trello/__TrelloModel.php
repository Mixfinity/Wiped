<?php
	class TrelloModel extends CI_Model  {
		...
		public function createBaseLists($f_id){

			$data = array();
			$data["name"] = "Correcties klant";
			$data["pos"] = "bottom";
			$result = $this->makeRequest("/board/" . $f_id . "/lists", $data, "POST");

			$data["name"] = "Checken";
			$data["pos"] = "bottom";
			$result = $this->makeRequest("/board/" . $f_id . "/lists", $data, "POST");

			$data["name"] = "Wacht op feedback";
			$data["pos"] = "bottom";
			$result = $this->makeRequest("/board/" . $f_id . "/lists", $data, "POST");
		...
		public function createBoard($data){ 
			if(is_array($data)){
				...
				$this->createBaseLists($current_board);
		...
		public function createChecklist(){
			$first_list = $this->getLists("5915ca89eb5e58627c817a01")[0]->id; 
			$data = array(
				"name" => "Controleren",
